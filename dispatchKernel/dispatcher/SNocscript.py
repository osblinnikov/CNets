...
def add_dependencies(env):
  ...
  '''[[[end]]] (checksum: 556401e848421b7ac163340abbf09474)'''
  AddPthreads(env)
  # AddNetwork(env) 

c = {}
c['PROG_NAME'] = 'dispatcher_dispatchKernel_cnets_osblinnikov_github_com'
# c['sourceFiles'] = ['dispatcher.c']
c['testFiles'] = ['dispatcherTest.c']
# c['runFiles'] = ['main.c']
# c['defines'] = []
