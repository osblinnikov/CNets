...
describe "mapBuffer-send-receive-perf-multi", ->
  it "should send many messages during 3 seconds", ->
    ...
    wrk0 = new s.com_github_osblinnikov_cnets_types.Worker('/test/specs/mapBufferPerfMulti.sender.js')
    wrk1 = new s.com_github_osblinnikov_cnets_types.Worker('/test/specs/mapBufferPerfMulti.sender.js')
    wrk2 = new s.com_github_osblinnikov_cnets_types.Worker('/test/specs/mapBufferPerfMulti.sender.js')
