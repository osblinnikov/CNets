...
def add_dependencies(env):
  ...
  '''[[[end]]] (checksum: 0ad7d0b81835401cd8efe6d5fffbba3e)'''
  AddPthreads(env)
  # AddNetwork(env) 

c = {}
c['PROG_NAME'] = 'topology_replicator_cnets_osblinnikov_github_com'
# c['sourceFiles'] = ['topology.c']
c['testFiles'] = ['topologyTest.c']
# c['runFiles'] = ['main.c']
# c['defines'] = []
