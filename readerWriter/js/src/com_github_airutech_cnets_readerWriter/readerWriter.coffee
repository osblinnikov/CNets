...
s.com_github_airutech_cnets_readerWriter =
  create: ()->
    that = this
    
    #dummy
#[[[end]]] (checksum: 45d66d2c2fab0a8a235cc434febfbcac)


#IMPLEMENTATION GOES HERE

s.com_github_airutech_cnets_readerWriter.reader = (bufKernParam)->
  self = this
...
s.com_github_airutech_cnets_readerWriter.writer = (bufKernParam)->
  self = this
  self.buffer = bufKernParam
...
s.com_github_airutech_cnets_readerWriter.statsCollectorStatic =
  w: null
  setWriter: (wIn)->
    if w == null
      w = wIn
...
if isNode
  module.exports = s.com_github_airutech_cnets_readerWriter