...
/****************************************************************************/
  ...
  */
  ...
  static LFDS611QUEUE_INLINE lfds611QUEUE_atom_t lfds611QUEUE_abstraction_increment( volatile lfds611QUEUE_atom_t *value )
  {
    ...
    rv = (lfds611QUEUE_atom_t) _InterlockedIncrement64( (__int64 *) value );
...
/****************************************************************************/
  ...
  */
  ...
  static LFDS611QUEUE_INLINE lfds611QUEUE_atom_t lfds611QUEUE_abstraction_increment( volatile lfds611QUEUE_atom_t *value )
  {
    ...
    rv = (lfds611QUEUE_atom_t) _InterlockedIncrement( (long int *) value );
...
/****************************************************************************/
  ...
  */
  ...
  static LFDS611QUEUE_INLINE lfds611QUEUE_atom_t lfds611QUEUE_abstraction_increment( volatile lfds611QUEUE_atom_t *value )
  {
    ...
    rv = (lfds611QUEUE_atom_t) __sync_add_and_fetch( value, 1 );
