...
/****************************************************************************/
  ...
  */
  ...
  static LFDS611QUEUE_INLINE lfds611QUEUE_atom_t lfds611QUEUE_abstraction_cas( volatile lfds611QUEUE_atom_t *destination, lfds611QUEUE_atom_t exchange, lfds611QUEUE_atom_t compare )
  {
    ...
    LFDS611QUEUE_BARRIER_COMPILER_FULL;

    rv = (lfds611QUEUE_atom_t) _InterlockedCompareExchangePointer( (void * volatile *) destination, (void *) exchange, (void *) compare );
...
/****************************************************************************/
  ...
  */
  ...
  static LFDS611QUEUE_INLINE lfds611QUEUE_atom_t lfds611QUEUE_abstraction_cas( volatile lfds611QUEUE_atom_t *destination, lfds611QUEUE_atom_t exchange, lfds611QUEUE_atom_t compare )
  {
    ...
    rv = (lfds611QUEUE_atom_t) __sync_val_compare_and_swap( destination, compare, exchange );
